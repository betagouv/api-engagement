...
export default function Hero({ onStartQuiz }: { onStartQuiz: () => void }) {
  return (
    <section className="bg-beige-gris-galet-975 relative overflow-hidden md:min-h-[max(560px,45vw)] lg:min-h-[max(700px,45vw)]">
      <div className="fr-container relative z-10 pb-8 md:pb-0">
        <div className="pt-8 md:max-w-[390px] md:pt-11 lg:max-w-[620px] lg:pt-[100px]">
          <p className="fr-h4 text-title-grey! mb-2!">Tu veux te rendre utile ?</p>
          <h1 className="text-title-grey! fr-mb-2w text-[40px]! leading-[48px]! md:text-[80px]! md:leading-[88px]!">À chacun sa façon d'agir</h1>
          ...
          <p className="fr-text--xs text-mention-grey fr-mt-1w mb-0! italic md:max-w-[260px]!">Réponds en quelques clics, on te propose une mission qui te correspond</p>
        </div>
      </div>
