...
export default function CadreMineurs() {
  return (
    <section className="fr-container">
      <div className="bg-[#6b93f6] flex flex-col items-center gap-6 rounded p-4 shadow-lg md:gap-10 md:p-12 lg:px-20! lg:py-10!">
        <h2 className="fr-h1 text-white! mb-0! text-center">
          Un cadre pensé pour les <span className="text-[#fbe769]">mineurs</span>
        </h2>

        <ul role="list" className="m-0! flex list-none! flex-col items-center gap-6 p-0! md:flex-row md:justify-center md:gap-16">
          {GARANTIES.map((garantie, index) => (
            <li key={`garantie-${index}`} className="text-white flex flex-col items-center gap-3.5 text-center text-xl font-bold md:text-2xl">
