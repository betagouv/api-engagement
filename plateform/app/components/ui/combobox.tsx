      ...
      {open && (
        ...
        >
          <div className="relative m-4">
            {/* eslint-disable jsx-a11y-x/no-autofocus -- À l'ouverture, le focus est volontairement placé dans la recherche puis restitué au bouton à la fermeture. */}
            <input
              type="text"
              autoFocus
              value={search}
            ...
            />
            {/* eslint-enable jsx-a11y-x/no-autofocus */}
          ...
          {/* eslint-disable-next-line jsx-a11y-x/no-noninteractive-element-interactions -- Le fieldset délègue aux contrôles natifs le suivi du pointeur et la validation clavier du panneau. */}
          <fieldset
