...
const Broadcast = ({ data, year }: { data: StatsReport; year: number }) => {
  ...
  return (
    <div className="w-full p-8">
      <h2 className="text-xl font-bold mb-6">Votre rôle de diffuseur</h2>
      <div className="flex items-start gap-8">
        <div className="flex-1 bg-white p-8 h-full space-y-6">
          ...
          <div className="w-full h-[300px]">
            <LineChart data={data.send.graphYears} />
          </div>
          <div className="flex items-start gap-6">
            <div className="flex-1 space-y-6">
              <div className="space-y-2">
                <h4 className="text-sm font-bold text-[#000091]">Redirections ce mois-ci</h4>
                <p className="text-base font-bold">{data.send.click.toLocaleString("fr")}</p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-base font-bold">{data.send.clickYear.toLocaleString("fr")}</p>
                <div className="flex item-center gap-2">
            ...
            <div className="flex-1 space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-base font-bold">{data.send.apply.toLocaleString("fr")}</p>
                <div className="flex item-center gap-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-base font-bold">{data.send.applyYear.toLocaleString("fr")}</p>
                <div className="flex item-center gap-2">
        ...
        <div className="space-y-6 flex-1">
          <div className="w-full bg-white p-8 h-full space-y-6">
            ...
            <table className="table-fixed w-full">
              <tbody className="p-0 m-0 text-xs">
                {data.send.topOrganizations.length ? (
                  data.send.topOrganizations.map((item, i) => (
                    <tr key={i}>
                      ...
                      <td className="text-[#666666]">{(item.doc_count / data.send.click).toLocaleString("fr", { style: "percent", maximumFractionDigits: 2 })}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
          ...
          <div className="w-full bg-white p-8 h-full space-y-6">
            ...
            <div className="w-full h-[300px]">
              {data.send.organizationHistogram.length > 0 ? (
                <BarChart data={data.send.organizationHistogram} />
              ) : (
