...
CREATE TABLE "_QueryWidgetMission" (
    ...
    CONSTRAINT "_QueryWidgetMission_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_ClickApplies" (
    ...
    CONSTRAINT "_ClickApplies_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_ClickAccounts" (
    ...
    CONSTRAINT "_ClickAccounts_AB_pkey" PRIMARY KEY ("A","B")
);
