  ...
  return (
    <div className="relative w-full min-w-[6rem]" ref={ref}>
      ...
      <div className={`absolute ${position} mt-1 z-50 ${width} border border-[#DDDDDD] bg-white shadow-md ${show ? "block" : "hidden"}`} role="group" aria-labelledby={id}>
        <ul className="p-4 w-full max-h-60 overflow-y-scroll">
          {options?.length === 0 ? (
            ...
            options.map((item, index) => {
              ...
              return (
                <li
                  ...
                  tabIndex={0}
                  className="w-full flex items-center justify-between gap-2 text-sm px-4 py-2 cursor-pointer hover:bg-[#0000000A] focus:outline-none focus-visible:ring focus-visible:ring-blue-800 focus-visible:bg-[#0000000A]"
                  onClick={() => {
                    handleToggle(item);
        ...
        <div className="p-4 w-full flex items-center justify-between border-t border-[#DDDDDD]">
          <button
            className="text-sm cursor-pointer px-2 focus:outline-none focus-visible:ring focus-visible:ring-blue-800"
          ...
          <button
            className={`text-sm px-3 h-8 flex items-center text-white focus:outline-none focus-visible:ring focus-visible:ring-blue-800 ${!selection || selection.length === 0 ? "opacity-50 cursor-not-allowed" : ""}`}
            style={{
