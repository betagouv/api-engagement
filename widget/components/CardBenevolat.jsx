...
const Card = ({ widget, mission, request, focused = false, onKeyDown = null, onRef = null }) => {
  ...
  return (
    <div
      ...
      } relative group mx-auto flex h-full flex-col overflow-hidden border border-gray-900 transition-shadow duration-300 hover:shadow-lg focus-within:ring-2 focus-within:ring-[#000091] focus-within:ring-offset-0`}
    >
      ...
      <div className="h-[276px] sm:h-[292px] flex flex-col justify-between p-6 sm:p-8 gap-4">
        ...
        >{`${mission.places} ${mission.places > 1 ? "bénévoles recherchés" : "bénévole recherché"}`}</p>
      </div>
    </div>
  );
};
