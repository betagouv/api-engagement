...
export const TAXONOMY = {
  ...
  competence_rome: {
    ...
    values: {
      ...
      je_ne_sais_pas: { label: "Autre / Je ne sais pas", icon: "‍‍🤔‍", enrichable: false, neutral: true },
    },
  },
  ...
  region_internationale: {
    ...
    values: {
      ...
      je_ne_sais_pas: { label: "Je ne sais pas encore", icon: null, enrichable: false, neutral: true },
    },
  },
  ...
  engagement_intent: {
    ...
    values: {
      ...
      exploration: { label: "Je ne sais pas encore", icon: "🤷", enrichable: false, neutral: true },
    },
  },
  ...
  activite: {
    ...
    values: {
      aider_accompagner: {
        ...
        icon: "❤️",
        enrichable: true,
        mission_card_tag: "Aide des personnes",
      },
      transmettre_animer: {
        label: "Transmettre et animer",
        icon: "📢",
        enrichable: true,
        mission_card_tag: "Anime et accompagne",
      },
      fabriquer_reparer_terrain: {
        label: "Fabriquer, réparer ou agir sur le terrain",
        icon: "🛠️",
        enrichable: true,
        mission_card_tag: "Une mission concrète",
      },
      secourir_proteger: {
        label: "Secourir et protéger",
        icon: "🛟",
        enrichable: true,
        mission_card_tag: "Agis sur le terrain",
      },
      organiser_coordonner: {
        label: "Organiser et coordonner",
        icon: "🗓️",
        enrichable: true,
        mission_card_tag: "Coordonne des projets",
      },
      creer_communiquer: {
        label: "Créer et communiquer",
        icon: "🎨",
        enrichable: true,
        mission_card_tag: "Mets ta créativité au service d’une cause",
      },
    },
  },
  ...
  equipe: {
    ...
    values: {
      ...
      petit_groupe: {
        ...
        icon: "🌿",
        enrichable: true,
        mission_card_tag: "Une équipe de moins de 10 bénévoles",
      },
      grand_collectif: {
        label: "Dans un grand collectif où il y a beaucoup de monde",
        icon: "🌳",
        enrichable: true,
        mission_card_tag: "Une grande équipe engagée",
      },
      peu_importe: {
        label: "Peu importe",
        icon: "🤔",
  ...
  autonomie: {
    ...
    values: {
      ...
      cadre_suivi_regulier: {
        ...
        icon: "🚀",
        enrichable: true,
        mission_card_tag: "Des consignes bien définies",
      },
      je_ne_sais_pas: {
        label: "Peu importe",
        icon: "🤔",
  ...
  imprevu: {
    ...
    values: {
      adaptation_rapide: {
        ...
        icon: "🚀",
        enrichable: true,
        mission_card_tag: "Un environnement dynamique",
      },
      imprevu_modere: {
        label: "Un peu d’imprévu, ça me va",
        icon: "💪",
        enrichable: true,
        mission_card_tag: "Des journées qui se ressemblent rarement",
      },
      cadre_previsible: {
        label: "Je préfère savoir à quoi m’attendre",
        icon: "🧘",
        enrichable: true,
        mission_card_tag: "Un cadre stable et rassurant",
      },
      je_ne_sais_pas: {
        label: "Je ne sais pas encore",
        icon: "🤔",
  ...
  formation_onisep: {
    ...
    values: {
      ...
      je_ne_sais_pas: { label: "Je ne sais pas encore", icon: "🤷", enrichable: false, neutral: true },
    },
  },
  ...
  motivation_recherche: {
    ...
    values: {
      ...
      rencontres: {
        ...
        icon: "🤝",
        enrichable: true,
        mission_card_tag: "Fais de nouvelles rencontres",
      },
      decouverte_metier: {
        label: "Je veux découvrir un métier",
        icon: "🧭",
        enrichable: true,
        mission_card_tag: "Teste avant de t’engager",
      },
      indemnisation: {
        label: "Je cherche une mission indemnisée",
        icon: "💸",
        enrichable: false,
        mission_card_tag: "Rémunéré",
      },
      agir_pour_une_cause: {
      ...
      horaires_flexibles: {
        ...
        icon: "📅",
        enrichable: true,
        mission_card_tag: "Horaires flexibles",
      },
      securite_pays: {
        label: "Je veux contribuer à la sécurité de mon pays",
        icon: "🪖",
        enrichable: true,
        mission_card_tag: "Contribue à la sécurité de tous",
      },
      remote: {
        label: "Je veux pouvoir participer à distance",
        icon: "💻",
        enrichable: false,
        mission_card_tag: "À distance",
      },
      autre: {
        label: "Je ne sais pas encore",
        icon: "🤔",
  ...
  tranche_age: {
    ...
    values: {
      ...
      entre_25_30_ans: { label: "26-30 ans", icon: null, enrichable: false },
      entre_30_45_ans: { label: "31-45 ans", icon: null, enrichable: false },
