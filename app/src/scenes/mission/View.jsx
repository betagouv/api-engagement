        ...
        <div className="flex justify-between">
          <div>
            <h2 className="text-3xl font-bold">
              <span className="font-normal text-gray-dark">Mission provenant de </span>
          ...
          <a className="button flex cursor-pointer items-center text-sm text-blue-dark" href={buildLink(mission)} target="_blank">
        ...
        <div className="flex gap-4 border border-gray-border p-6">
          ...
          <div>
            <div className="mb-4 flex items-center">
              ...
              <span className="ml-3 rounded-full bg-gray-light px-3 py-2">{mission.domain}</span>
            </div>
            <div className="mb-4 flex items-center">
              <p className="text-xs font-semibold uppercase text-gray-dark">Activités</p>
              <span className="ml-3 rounded bg-purple-light px-3 py-1 text-xs font-semibold uppercase text-purple-dark">{mission.activity}</span>
            </div>
