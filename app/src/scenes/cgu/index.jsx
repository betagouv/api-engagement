      ...
      <div className="mx-auto my-14 w-4/5 max-w-[1200px] flex-1 space-y-10">
        ...
        <div className="bg-white py-12 px-24 border space-y-10 text-base">
          ...
          <div className="space-y-6">
            ...
            <p>
              <b>La Plateforme</b> est un dispositif mis en œuvre par la Direction de la jeunesse, de l'éducation populaire et de la vie associative (DJEPVA) au sein du ministère
              des Sports, de la Jeunesse et de la Vie associative. L’API Engagement permet aux plateformes d’engagement de mettre en commun leurs missions de bénévolat et de
              volontariat, dans le but d’accroître leur visibilité.
            </p>
          </div>
          <div className="space-y-6">
            ...
            <p>
              “Partenaire” désigne tout acteur privé ou public qui diffuse des missions de bénévolat ou de volontariat, signataire d’une convention de partenariat pour utiliser la
              Plateforme.
            </p>
            <p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p>
                L’Éditeur réalise un contrôle à priori des missions de bénévolat et de volontariat proposées par l’Utilisateur, dans le but de garantir notamment la qualité du
                contenu diffusé.{" "}
              </p>
            </div>
            <div className="space-y-4">
              ...
              <p>
                Il est rappelé que toute personne procédant à une fausse déclaration pour elle-même ou ou pour autrui s’expose notamment aux sanctions prévues à l’article 4 -41-1
                du code pénal.{" "}
              </p>
              <p>
          ...
          <div className="space-y-6">
            ...
            <p>
              Les termes des présentes CGU peuvent être amendés à tout moment, sans préavis, en fonction des modifications apportées à la Plateforme, de l’évolution de la
              législation ou pour tout autre motif jugé nécessaire. Chaque modification donne lieu à une nouvelle version qui est acceptée par l’Utilisateur.
            </p>
          </div>
        </div>
      </div>
