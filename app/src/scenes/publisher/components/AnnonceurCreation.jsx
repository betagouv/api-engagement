  ...
  return (
    <div className="space-y-6 border border-gray-900 p-6">
      <div className="flex items-center justify-between">
        ...
        <Toggle aria-label={isAnnonceur ? "Désactiver le mode annonceur" : "Activer le mode annonceur"} value={isAnnonceur} onChange={(e) => onChange({ ...values, isAnnonceur: e, missionType: null })} />
      </div>
      {isAnnonceur && (
        <>
