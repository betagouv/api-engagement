          ...
          <div className="flex flex-col">
            ...
            <div className="mt-2 flex flex-col gap-2">
              <div className="flex items-center gap-2">
                {(values.newPassword || "").length >= 12 ? <RiCheckboxCircleFill className="text-success" aria-hidden="true" /> : <RiCheckboxCircleFill className="text-text-mention" aria-hidden="true" />}
                <span className={`align-middle text-sm ${values.newPassword && (values.newPassword || "").length >= 12 ? "text-success" : "text-text-mention"}`}>
                  Au moins 12 caractères
                </span>
              </div>
              <div className="flex items-center gap-2">
                {/[a-zA-Z]/.test(values.newPassword) ? <RiCheckboxCircleFill className="text-success" aria-hidden="true" /> : <RiCheckboxCircleFill className="text-text-mention" aria-hidden="true" />}
                <span className={`align-middle text-sm ${values.newPassword && /[a-zA-Z]/.test(values.newPassword) ? "text-success" : "text-text-mention"}`}>
                  Au moins une lettre
                </span>
              </div>
              <div className="flex items-center gap-2">
                {/[0-9]/.test(values.newPassword) ? <RiCheckboxCircleFill className="text-success" aria-hidden="true" /> : <RiCheckboxCircleFill className="text-text-mention" aria-hidden="true" />}
              ...
              <div className="flex items-center gap-2">
                {/[!-@#$%^&*(),.?":{}|<>]/.test(values.newPassword) ? <RiCheckboxCircleFill className="text-success" aria-hidden="true" /> : <RiCheckboxCircleFill className="text-text-mention" aria-hidden="true" />}
