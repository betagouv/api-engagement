...
import { RiArrowLeftLine, RiDeleteBin6Line, RiErrorWarningFill } from "react-icons/ri";
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="min-w-4xl">
      <div className="flex flex-col gap-6 p-10">
        <h2 className="text-lg font-bold">🥳 Votre campagne est créée !</h2>
        ...
        <div className="border-blue-france-925 bg-blue-france-975 flex items-center justify-between border px-4 py-4">
