...
export const createTestMission = async (data: Partial<MissionCreateInput & { deleted?: boolean }> = {}): Promise<MissionRecord> => {
  ...
  const missionInput: MissionCreateInput = {
    ...
    reducedMobilityAccessible: data.reducedMobilityAccessible ?? "yes",
    closeToTransport: data.closeToTransport ?? "yes",
    openToMinors: data.openToMinors ?? "yes",
    ...
    leboncoinStatus: data.leboncoinStatus,
    leboncoinUrl: data.leboncoinUrl,
    leboncoinComment: data.leboncoinComment,
    leboncoinUpdatedAt: data.leboncoinUpdatedAt,
    jobteaserStatus: data.jobteaserStatus,
    jobteaserUrl: data.jobteaserUrl,
    jobteaserComment: data.jobteaserComment,
    jobteaserUpdatedAt: data.jobteaserUpdatedAt,
    letudiantPublicId: data.letudiantPublicId,
    letudiantUpdatedAt: data.letudiantUpdatedAt,
    letudiantError: data.letudiantError,
