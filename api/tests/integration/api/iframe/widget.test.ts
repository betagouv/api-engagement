...
import { createTestWidget, createTestPublisher } from "../../../fixtures";
import type { WidgetRecord } from "../../../../src/types/widget";

describe.sequential("GET /iframe/widget", () => {
  ...
  describe("Error cases", () => {
    it("should return 404 for non-existent name", async () => {
      const response = await request(app)
        .get("/iframe/widget")
        .query({ name: "Non Existent Widget" })
        .expect(404);
