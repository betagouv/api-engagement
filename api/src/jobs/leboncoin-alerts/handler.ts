...
export interface LeboncoinAlertsJobPayload {}

export interface LeboncoinAlertsJobResult extends JobResult {}
...
export class LeboncoinAlertsHandler implements BaseHandler<LeboncoinAlertsJobPayload, LeboncoinAlertsJobResult> {
  name = "Alertes Leboncoin";

  async handle(): Promise<LeboncoinAlertsJobResult> {
