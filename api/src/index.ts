...
import RNAController from "./controllers/rna";
...
import StatsReportController from "./controllers/stats-report";
...
app.use("/stats-report", StatsReportController);
